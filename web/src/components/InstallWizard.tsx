...
export function InstallWizard({ onComplete }: { onComplete: () => void }) {
  ...
  const [appName, setAppName] = useState('E-Chat Business');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#246BFD] via-[#1A56DB] to-[#6C5CE7] p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#246BFD] to-[#6C5CE7] p-6 text-white">
          ...
          <p className="text-white/80 text-sm">Set up your E-Chat Business application</p>
          {/* Step indicators */}
        ...
        <div className="p-6">
          ...
          {step === 0 && (
            <div className="text-center">
              ...
              <h2 className="text-lg font-semibold text-gray-900 mb-2">Welcome to E-Chat Business</h2>
