...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'auth.scanInstructions': 'افتح واتساب للأعمال على هاتفك وامسح رمز QR هذا',
  ...
  tr: {
    ...
    'auth.scanInstructions': 'Telefonunuzda WhatsApp Business Chat açın ve bu QR kodunu tarayın',
  ...
  ru: {
    ...
    'auth.scanInstructions': 'Откройте WhatsApp Business Chat на телефоне и отсканируйте этот QR-код',
  ...
  zh: {
    ...
    'auth.logout': '退出',
    'auth.scanQr': '扫描二维码',
    'auth.scanInstructions': '在手机上打开WhatsApp商务聊天并扫描此二维码',
    'chat.newChat': '新聊天',
