export type Language = 'en' | 'es' | 'fr' | 'de' | 'pt' | 'hi' | 'ar' | 'tr' | 'ru' | 'zh';
...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'auth.scanInstructions': 'Open E-Chat on your phone and scan this QR code',
  ...
  es: {
    ...
    'auth.scanInstructions': 'Abre E-Chat en tu teléfono y escanea este código QR',
  ...
  fr: {
    ...
    'auth.scanInstructions': 'Ouvrez E-Chat sur votre téléphone et scannez ce code QR',
  ...
  de: {
    ...
    'auth.scanInstructions': 'Öffne E-Chat auf deinem Handy und scanne diesen QR-Code',
  ...
  pt: {
    ...
    'auth.logout': 'Sair',
    'auth.scanQr': 'Escanear codigo QR',
    'auth.scanInstructions': 'Abra o E-Chat no seu celular e escaneie este código QR',
  ...
  hi: {
    ...
    'auth.scanInstructions': 'अपने फोन पर E-Chat खोलें और इस QR कोड को स्कैन करें',
  ...
  ar: {
    ...
    'auth.scanInstructions': 'افتح E-Chat على هاتفك وامسح رمز QR هذا',
  ...
  tr: {
    ...
    'auth.scanInstructions': 'Telefonunuzda E-Chat açın ve bu QR kodunu tarayın',
  ...
  ru: {
    ...
    'auth.scanInstructions': 'Откройте E-Chat на телефоне и отсканируйте этот QR-код',
  ...
  zh: {
    ...
    'auth.logout': '退出',
    'auth.scanQr': '扫描二维码',
    'auth.scanInstructions': '在手机上打开E-Chat并扫描此二维码',
    'chat.newChat': '新聊天',
